...
const FS = require("fs");
class C4CSVFileStreamParser {
    constructor(logger, downloadPath) {
        this.name = "csv-stream";
        this.isStream = true;
        this.logger = null;
        this.downloadPath = "";
        this.contentTypes = ["text/csv"];
        this.logger = logger;
...
exports.default = C4CSVFileStreamParser;
//# sourceMappingURL=C4CSVFileStreamParser.js.map