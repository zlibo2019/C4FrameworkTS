...
export declare type SubscribeCallback = (message: any, headers: {
    [key: string]: any;
...
export declare const DEFAULT_PUBLISHER = "@_Default_Publisher_@";
export declare const DEFAULT_ROUTE = "@_Default_Route_@";
