...
export declare type Swagger2ParameterIn = 'query' | 'header' | 'path' | 'body' | 'formData';
export declare type Swagger2ParameterType = 'string' | 'number' | 'integer' | 'boolean' | 'array' | 'file';
export declare type Swagger2ParameterFormat = 'int32' | 'int64' | 'float' | 'double' | 'string' | 'byte' | 'binary' | 'boolean' | 'date' | 'date-time' | 'passwor';
export declare type Swagger2ParameterCollectionFormat = 'csv' | 'ssv' | 'tsv' | 'pipes' | 'multi';
export declare type Swagger2SecurifyType = "basic" | 'apiKey' | 'oauth2';
...
export declare type Swagger2ParameterNotBodyObject = Swagger2ParameterPathObject | Swagger2ParameterOtherObject;
export declare type Swagger2ParameterObject = Swagger2ParameterBodyObject | Swagger2ParameterNotBodyObject;
...
export declare type Swagger2SecurifySchemeObject = Swagger2SecurifyBasicSchemeObject | Swagger2SecurifyAPIKeySchemeObject | Swagger2SecurifyOauth2SchemeObjcet;
